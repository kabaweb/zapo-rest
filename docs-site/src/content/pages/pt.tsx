        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Falha no download/store após retries (<code>mediaStage: "failed"</code> + erro)</td>
            </tr>
          </tbody>
        </table>
        <p>
...
← JSON { "op":"ended" }`}
        ...
        <ul>
          ...
          <li>
            Gravação: <code>PUT.../settings/call-recording</code> + storage ready → WAV em <code>GET.../recording</code>
          </li>
        </ul>
      </>
    ),
